...
import { TraversalType } from "../types/BPlusTreeTypes";

interface BPlusTreeTraversalControlsProps {
  onStart: () => void;
  onPause: () => void;
  onReset: () => void;
...
export const BPlusTreeTraversalControls = ({
  onStart,
  onPause,
  onReset,
  isTraversing,
...
}: BPlusTreeTraversalControlsProps) => {
  return (
